...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { descripcion: @registry.descripcion, finalizado: @registry.finalizado, proyecto_id: @registry.proyecto_id, resultado: @registry.resultado, titulo: @registry.titulo, user_id: @registry.user_id } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { descripcion: @registry.descripcion, finalizado: @registry.finalizado, proyecto_id: @registry.proyecto_id, resultado: @registry.resultado, titulo: @registry.titulo, user_id: @registry.user_id } }
